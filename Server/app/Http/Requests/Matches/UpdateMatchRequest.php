...
/**
 * Same shape as StoreMatchRequest, but every field is `sometimes` so the
 * SPA can do partial PATCH-style updates without resending the whole form.
 */
class UpdateMatchRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'match_date'        => ['sometimes', 'required', 'date', 'before_or_equal:today'],
            'format'            => ['sometimes', 'required', Rule::in(['T20', 'ODI', 'Test', 'Club', 'Other'])],
